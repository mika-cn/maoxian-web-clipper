...
//   - on Chrome, the extension's public key which will be hashed to extension id.
//
...
// The update manifest file's URL that we self hosted (Chrome).
...
function renderManifestWithPlatformMsg(content, path) {
  ...
  switch(PLATFORM) {
    case 'chrome':
      manifest.key = PLATFORM_ID; // Extension id
