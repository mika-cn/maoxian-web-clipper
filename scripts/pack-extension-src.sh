...
echo "After you extracting the source file and changing directory to the extracted folder, run the belowing command to build the code:" >> $reviewer_file_path
echo "" >> $reviewer_file_path
