(function (root, factory) {
  ...
  const values = {
    ...
    "label.download-dir": "下载目录: ",

    // hints
    "hint.native-app-reload": "重启本地程序，以加载最新配置",
    ...
    "notice.success.permissions-granted": "已授予权限",
    ...
    "notice.file-url.intro": "这一设置项，是用来告知浏览器扩展，你允许它访问本地网址 (file://打头的网址)。<br> 默认情况下，MaoXian 是不能打开裁剪下来的网页（本地文件）这会导致想要预览刚裁剪下来的文件，变得很困难<br> 允许访问本地网址后，你就可以更方便地打开裁剪下来的文件",
    "notice.file-url.link-label": "<br>查看如何设置",
