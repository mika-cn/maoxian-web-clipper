...
const values = {
  "tab.not-found": "无法找到当前激活的网页。你可以先点击要裁剪的网页，使其处于聚焦状态，再试一次",
  "tab.not-http": "目标网页 （ID: ${id} 标题: ${title}, 网址: ${url}） 非 HTTP 网页，无法裁剪",
  ...
  "tab.still-loading": "目标网页 （ID: ${id} 标题: ${title}, 网址: ${url}） 仍在加载中，请等待其加载完成再裁剪。若目标网页由于网络问题，而迟迟无法加载完成，可按下『Esc』键，强制其结束加载，再裁剪。",
