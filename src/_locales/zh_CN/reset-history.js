...
const values = {
  ...
  "current-storage-path-value": "<code>下载目录</code> / <code>${rootFolder}</code><br />其中<code>${rootFolder}</code> 为根目录，如果该值和你要选择的目录名字不一致，请到 <a href='go.page:extPage.setting#setting-storage' target='_blank'>设置 &gt; 存储 </a>修改根目录的值，再进行重置。",
  "processing": "正在重置...",
